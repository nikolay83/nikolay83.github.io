...
controllers.controller("businessHomeStepOneCtrl", function ($scope, $location, $rootScope) {
    // reset modal
...
// resetPasswordCtrl
controllers.controller("resetPasswordCtrl", function ($scope, $location,$rootScope) {
    // reset alert box
    $rootScope.closeModal();
    $scope.validateErrorMsg = "";
    // tool function for validate form data
