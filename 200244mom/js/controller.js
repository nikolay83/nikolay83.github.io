...
//Main Controller
controllers.controller("mainCtrl",function($scope,$rootScope, $location,  localStorageService ){
...
controllers.controller("postCardsCtrl",function($scope,postList,$rootScope){
	$rootScope.modal = false;
	//Get History
...
controllers.controller('championMyInfoCtrl', ['$scope', '$rootScope', 'infoList', 'passwordList', 
    function ($scope, $rootScope, infoList, passwordList) {
...
controllers.controller('founderMyInfoCtrl', ['$scope', '$rootScope', 'infoList', 'passwordList', 
    function ($scope, $rootScope, infoList, passwordList) {
...
controllers.controller("shoppingCartCtrl",function($scope,cartList,$rootScope, $location, localStorageService){
	$rootScope.modal = false;
	//Get Shopping Cart
