...
var app = angular.module("app", ["ngRoute", "ngDropdowns", "flow", "infinite-scroll", 'LocalStorageModule', 'ui.bootstrap',
    "ng.deviceDetector", "cgNotify", "crumble", "angulartics", "angulartics.google.analytics"]);

// Initialize the main module
app.run(['$rootScope', '$location', '$window', '$log', '$interval', 'SecurityService', 'UserService', 'storage', 'config', 'util', 'GiftCardOfferService', 'crumble',
	function ($rootScope, $location, $window, $log, $interval, SecurityService, UserService, storage, config, util, GiftCardOfferService, crumble) {
    ...
    function ($routeProvider) {
        $routeProvider
            ...
            .when('/Forum/:threadId', {
                ...
                hasAside: true,
                headerPage: 'forum',
                label: 'THREADS OF {{threadTitle|uppercase|cutString:45:"..."}}',
                parent: '/Forum'
            })
            .when('/Forum/Thread/Details', {
                templateUrl: 'forum/ThreadDetails.html',
                controller: 'forumThreadDetailCtrl',
                controllerAs: 'vm',
                isPublic: true,
                hasAside: true,
                headerPage: 'forum',
                label: '{{threadDetailTitle|uppercase}}',
                parent: '/Thread'
            })
            .when('/Forum/Thread/Details/Replay', {
                templateUrl: 'forum/ThreadDetailReplay.html',
                controller: 'forumThreadDetailReplayCtrl',
                controllerAs: 'vm',
                isPublic: true,
                hasAside: true,
                headerPage: 'forum',
                label: 'Reply',
                parent: '/Forum/Thread/Details'
            })
            .when('/Forum/Thread/Details/QuoteReplay', {
                templateUrl: 'forum/ThreadDetailReplay.html',
                controller: 'forumThreadDetailQuoteReplayCtrl',
                controllerAs: 'vm',
                isPublic: true,
                hasAside: true,
                headerPage: 'forum',
