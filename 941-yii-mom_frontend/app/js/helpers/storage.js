...
angular.module("app")
    .factory('storage', [function () {
        ...
        /**
         * store Forum Nickname
         */
        service.storeForumNickname = function(nickname) {
            localStorage.setItem('momandpop.forum.nickname', nickname);
        };

        /**
         * Return the stored Nickname
         */
        service.getForumNickname = function() {
            return localStorage.getItem('momandpop.forum.nickname');
        };
